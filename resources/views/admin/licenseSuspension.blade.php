...
<head>
    ...
    <title>License Suspension - Admin</title>
                        ...
                        @foreach($suspensions as $suspension)
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <button class="btn-edit-custom" onclick="openEditModal({{ $suspension }})"><i class="fas fa-edit"></i> Edit</button>
                                    <button class="btn-delete-custom" onclick="deleteSuspension({{ $suspension->suspension_id }})"><i class="fas fa-trash"></i> Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    @endif
