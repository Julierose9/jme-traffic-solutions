    ...
    <div class="flex">
        <div class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('violation.history') }}"class="active"><i class="fas fa-exclamation-triangle"></i> Violation History</a>
        ...
        <div class="main-content">
            <h1 class="text-2xl font-bold">Violation History</h1>
           
            @if($violationRecords->isEmpty())
                <div class="no-records">
                    <h2>No Violation History Found</h2>
                    <p>You have not received any violations yet.</p>
                </div>
            @else
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach($violationRecords as $violation)
                        <tr>
